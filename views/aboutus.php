  ...
  <main>
    ...
    <section class="section">
      <div class="product-banner">
        <div class="left">
          <img src="static/images/shopping1.jpg" alt="" />
        </div>
        <div class="right">
          <div class="hero-content-aboutus">
        ...
        <div class="row">
          ...
          foreach ($team as $team_member) {
            ...
            <div class="single_team">
              <div class="thumb">
                <img src="' . $team_member["image"] . '" alt="">
                <div class="social_link">
                  <a href="' . $team_member["email"] . '" target="_blank"><i class="fa fa-envelope"></i></a>
                  <a href="' . $team_member["twitter_link"] . '"target="_blank"><i class="fa fa-twitter"></i></a>
                  <a href="' . $team_member["linkedin_link"] . '"target="_blank"><i class="fa fa-linkedin"></i></a>
                </div>
              </div>
